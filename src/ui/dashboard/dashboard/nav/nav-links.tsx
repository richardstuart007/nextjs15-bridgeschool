      ...
      {links.map(link => {
        return (
          <Link
            ...
            href={link.href}
            className={clsx(
              'flex h-8 grow items-center justify-center gap-1 rounded-md bg-gray-50 p-1 text-xs font-medium hover:bg-sky-200 hover:text-red-600 md:flex-none md:p-2 md:px-2',
              {
