...
(
    rf_rid integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
(
    ...
    CONSTRAINT tsb_subject_sb_sid_key UNIQUE (sb_sid)
);

DROP TABLE IF EXISTS public.tdb_database;
CREATE TABLE IF NOT EXISTS public.tdb_database
(
    db_did integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
(
    us_uid integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    ...
    CONSTRAINT tus_users_pkey PRIMARY KEY (us_uid),
...
(
    ...
    up_email text ,
    CONSTRAINT tup_userspwd_pkey PRIMARY KEY (up_uid)
);

DROP TABLE IF EXISTS public.ths_history;
CREATE TABLE IF NOT EXISTS public.ths_history
(
    hs_hid integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    ...
    hs_uid integer,
    hs_sid integer DEFAULT 0,
    CONSTRAINT ths_history_hs_hid_key UNIQUE (hs_hid)
);

DROP TABLE IF EXISTS public.tlg_logging;
CREATE TABLE IF NOT EXISTS public.tlg_logging
(
    lg_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    ...
    CONSTRAINT tlg_logging_lg_id_key UNIQUE (lg_id)
);

DROP TABLE IF EXISTS public.tow_owner;
CREATE TABLE IF NOT EXISTS public.tow_owner
(
    ow_oid integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
