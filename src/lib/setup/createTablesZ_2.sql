...
(
    ...
    CONSTRAINT z_2database_pkey PRIMARY KEY (d_name)
);
...
(
    ...
    CONSTRAINT z_2library_pkey PRIMARY KEY (lrowner, lrgroup, lrref),
    CONSTRAINT z_2library_lrlid_key UNIQUE (lrlid)
);
...
(
    ...
    CONSTRAINT z_2logging_lgid_key UNIQUE (lgid)
);
...
(
    ...
    CONSTRAINT z_2owner_pkey PRIMARY KEY (oowner)
);
...
(
    ...
    CONSTRAINT z_2ownergroup_pkey PRIMARY KEY (ogowner, oggroup),
    CONSTRAINT z_2ownergroup_oggid_key UNIQUE (oggid)
);
...
(
    ...
    qsouth text[] ,
    qwest text[] ,
    CONSTRAINT z_2questions_pkey PRIMARY KEY (qowner, qgroup, qseq),
    CONSTRAINT z_2questions_qqid_key UNIQUE (qqid)
);
...
(
    ...
    CONSTRAINT z_2reftype_pkey PRIMARY KEY (rttype),
    CONSTRAINT z_2reftype_rtrid_key UNIQUE (rtrid)
);
...
(
    ...
    CONSTRAINT z_2sessions_s_id_key UNIQUE (s_id)
);
...
(
    ...
    CONSTRAINT z_2users_pkey PRIMARY KEY (u_uid),
    CONSTRAINT z_2users_u_email_key UNIQUE (u_email)
);
...
(
    ...
    CONSTRAINT z_2usershistory_r_hid_key UNIQUE (r_hid)
);
...
(
    ...
    CONSTRAINT z_2usersowner_pkey PRIMARY KEY (uouid, uoowner)
);
...
(
    ...
    upemail text ,
    CONSTRAINT z_2userspwd_pkey PRIMARY KEY (upuid)
);
...
(
    ...
    CONSTRAINT z_2who_pkey PRIMARY KEY (wwho),
    CONSTRAINT z_2who_wwid_key UNIQUE (wwid)
);
