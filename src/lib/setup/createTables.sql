...
DROP TABLE IF EXISTS public.ownergroup;
...
DROP TABLE IF EXISTS public.usershistory;
...
DROP TABLE IF EXISTS public.usersowner;
...
DROP TABLE IF EXISTS public.userspwd;
...
DROP TABLE IF EXISTS public.who;
